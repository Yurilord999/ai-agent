...
schema_get_file_content = types.FunctionDeclaration(
    ...
    description="Reads file content in a specified directory relative to the working directory, providing a specified amount of characters, truncated if necessary",
